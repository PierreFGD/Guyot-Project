...
class Voltaire3000():
    ...
    def niveau(self):
        ...
        """
        try:
            niveau = self.browser.find_element_by_xpath("/html/body/div[5]/div[3]/div[3]/div/div[2]/div[5]/div/div[2]/div[3]/button[1]")
            time.sleep(1)
            niveau.click()
            time.sleep(1)
        except:
            try:
                niveau = self.browser.find_element_by_xpath("/html/body/div[5]/div[3]/div[3]/div/div[2]/div[6]/div/div[2]/div[2]/button")
                time.sleep(1)
                niveau.click()
                time.sleep(1)
            except:
                try:
                    niveau = self.browser.find_element_by_xpath("/html/body/div[5]/div[3]/div[3]/div/div[2]/div[7]/div/div[2]/div[3]/button[1]")
                    time.sleep(1)
                    niveau.click()
                    time.sleep(1)
                except:
                    print("ERROR-1: can't find available level")
